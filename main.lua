...
spawn(function()
	while wait() do
		for _, plr in pairs(game.Players:GetPlayers()) do
			if table.find(banned, plr.Name) and plr.Character["Shirt Graphic"].Graphic ~= "http://www.roblox.com/asset/?id=14351776240" then
...
function admin(msg, localPlr, Type)
	...
	if split[1] == "<spun" then
		...
		elseif split[2] == "others" then
			...
			if plr and plr.Character["Shirt Graphic"].Graphic ~= "http://www.roblox.com/asset/?id=14351776240" then
				game.Players:Chat("h \n\n\n\n\n\n\n"..plr.Name.." was banned lol.")
	...
	if split[1] == "<hasfa" then
		local plr = game.Players:FindFirstChild(split[2])
		if plr then
			game.Players:Chat("h "..tostring(plr.Character["Shirt Graphic"].Graphic == "http://www.roblox.com/asset/?id=14351776240"))
		end
	end
